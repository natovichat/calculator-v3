...
def main():
    ...
    if http_code == "200":
        ...
        run_cmd(
            f"python3 scripts/send.py --receiver beta_user --type Task --payload '{json.dumps(payload)}' --sender developer --conversation-id 64f713a0-1d01-4446-8ec3-3d510b89ac6c",
